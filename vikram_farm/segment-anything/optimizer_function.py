...
def doing(n, data_list, sam_checkpoint, ground_truth_filepath):
    ...
    rgb_mixer_image = mixer_function(data_list)
    # rgb_mixer_image1 = cv2.imread('/home/rajul/Desktop/segment-anything/input_images/ground_truth.png')
    masks = generate_masks(rgb_mixer_image, sam_checkpoint)
