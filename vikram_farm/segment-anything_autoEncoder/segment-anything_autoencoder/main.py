...
with rasterio.open('/home/rajul/Documents/segment-anything/input_images/pra.tif') as src:

    dataB = np.reshape(src.read(1),(637,902,3))
    #print(dataB.shape)
    data1 = dataB[:,:,0]
    data2 = dataB[:,:,1]
    data3 = dataB[:,:,2]
...
sam_checkpoint = "/home/rajul/Documents/segment-anything/segment_anything/notebooks/sam_vit_h_4b8939.pth"
ground_truth_filepath = '/home/rajul/Documents/segment-anything/MaskOutput/20220216_043712_70_2262_3B_AnalyticMS_SR_8b_clip_merged_masks.tif'

# Perform optimization
res = doing(n, data_list, sam_checkpoint, ground_truth_filepath)
